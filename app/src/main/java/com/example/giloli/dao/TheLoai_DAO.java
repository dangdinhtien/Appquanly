...
// lay tat ca danh sach the loai
    ...
    public ArrayList<TheLoaiDT> getAllTheLoai()throws ParseException {
    ...
    public Boolean checkMaNV(String MaTL){
        SQLiteDatabase db;
        db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("Select * from THELOAI where MaTL=?", new String[]{MaTL});
